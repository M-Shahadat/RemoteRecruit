...
const SignUpAd: React.FC = () => {
    return (
        <section className="fade-up-on-load relative overflow-hidden bg-[#EEF1FB] py-16 md:py-24 lg:py-32 reveal delay-${(index + 1) * 100}">
            {/* Background Assets */}
            <div className="pointer-events-none absolute inset-0 z-0">
                ...
                {/* Top-right blob */}
                <div className="reveal delay-200 absolute -right-[80px] -top-[100px] h-[300px] w-[300px] rounded-full bg-white/45 md:-right-[120px] md:-top-[155px] md:h-[430px] md:w-[430px]" />
                ...
                <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-0">
                    ...
                    <div className="px-0 pb-12 lg:col-span-5 lg:px-0 lg:pb-0">
                        <div className="mx-auto max-w-[520px] lg:mx-0">
                            ...
                            >
                                <span className="animate-bounce flex h-[50px] w-[50px] md:h-[62px] md:w-[62px] shrink-0 items-center justify-center rounded-full bg-[#51B7E0]">
